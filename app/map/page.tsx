      ...
      <main className="flex-1">
        <div className="container mx-auto px-4 py-8">
          ...
          <div className="grid gap-4 md:grid-cols-4 mb-8">
            <Card className="bg-white dark:bg-black border-gray-200 dark:border-gray-800 relative overflow-hidden transition-all duration-300 ease-out hover:scale-[1.03] hover:-translate-y-1 hover:shadow-xl cursor-pointer group">
