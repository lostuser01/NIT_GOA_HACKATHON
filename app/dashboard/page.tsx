                  ...
                  <div className="space-y-3 text-black dark:text-white">
                    <div className="flex items-start gap-3">
                      ...
                      <div className="flex-1 space-y-1">
                        <p className="text-sm font-medium">Pothole Repaired</p>
                    ...
                    <div className="flex items-start gap-3">
                      <div className="w-2 h-2 bg-green-500 rounded-full mt-2"></div>
                      <div className="flex-1 space-y-1">
                        <p className="text-sm font-medium">Citizen Feedback</p>
                ...
                <div className="flex flex-col gap-6">
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="p-3 bg-green-50 dark:bg-green-950/20 rounded-lg">
                      ...
                      <p className="text-xs text-muted-foreground">
                        Deploy 3 additional teams to Panjim City Center based on
                        demand
                      </p>
                    </div>
